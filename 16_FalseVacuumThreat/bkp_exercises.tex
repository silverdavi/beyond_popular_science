...
\textbf{2. Quantum Tunnelling Rates} \\[0.5em]
The tunnelling rate through a barrier scales as $\Gamma \propto e^{-S/\hbar}$, where $S$ is the action. For a simple quadratic barrier of height $E_0$ and width $L$, the action is approximately $S \approx \sqrt{2mE_0} \cdot L$. \\
