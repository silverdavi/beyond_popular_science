...
The fibres of these projection maps—the preimages of fixed pairwise patterns—form the basic objects on which \(F\) must be consistent. The Pareto condition fixes behaviour on unanimous fibres, while non-dictatorship prevents collapse to a single voter’s coordinate. The key insight is that these fibres cannot be globally stitched together without encountering a topological obstruction.
