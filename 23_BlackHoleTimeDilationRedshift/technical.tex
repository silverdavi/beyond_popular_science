...
The physical implication is that movement in \(r\) becomes mandatory. All future-directed timelike paths lead to smaller \(r\), ending at the singularity \(r = 0\). The singularity is not \QSOpen{}a place inside\QSClose{} but a moment in the infaller’s proper future.

This inversion  reflects the geometry. Any attempt to \QSOpen{}hover\QSClose{} or remain at constant \(r\) is no longer physically possible once inside the horizon.
