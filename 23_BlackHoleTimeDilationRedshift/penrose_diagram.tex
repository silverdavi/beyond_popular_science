...
\tikzstyle{cone}=[mydarkblue,line width=0.2,top colour=blue!60!black!30,
                  bottom colour=blue!60!black!50!red!30,shading angle=60,fill opacity=0.9]
...
\def\angb{acos(sqrt(\e)*sin(\ang))} % angle ellipse centre to point of tangency
...
\begin{tikzpicture}[scale=3.2]
  ...
  \def\d{0.5}
  \coordinate (O) at ( 0, 0); % centre: origin (r,t) = (0,0)
...
\begin{tikzpicture}[scale=3.5]
  ...
  % INFINITY LABELS
  \node[right=6,above left=-2,mydarkblue,align=centre] at (-1,0.04)
    {negative\\[-2]spacelike\\[-2]infinity ($i^0$)\\[-2]$x=-\infty$};
  \node[left=6,above right=-2,mydarkblue,align=centre] at (1,0.04)
  ...
  \node[mydarkblue,below right,align=centre] at (-60:0.65)
  ...
  \node[mydarkblue,below left,align=centre] at (-125:0.65)
...
\begin{tikzpicture}[scale=3.5]
  ...
  % INFINITY LABELS
  \node[above=1,above left=0,mydarkblue,align=centre] at (O)
    {$r=0$};
  \node[left=6,above right=-2,mydarkblue,align=centre] at (1,0.04)
...
\begin{tikzpicture}[scale=3.2]
  ...
  \coordinate (-O) at (-1, 0); % centre III: origin (r,t) = (0,0)
  \coordinate (-N) at (-1, 1); % north III: t=+infty, i+
  \coordinate (O)  at ( 1, 0); % centre I: origin (r,t) = (0,0)
