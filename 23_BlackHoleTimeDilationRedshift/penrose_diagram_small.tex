...
\begin{tikzpicture}[scale=3.2]
  ...
  \node[fill=mylightpurple,inner sep=2,align=centre] at (0,0.64) {II\\Black Hole};
  \node[fill=mylightpurple,inner sep=2,align=centre] at (0,-0.64) {IV\\White Hole};
  ...
  % INFINITY LABELS
  \node[above=1,left=1,mydarkblue,align=centre] at (-2,0) 
    {negative\\[-2]spacelike\\[-2]infinity ($i^0$)\\[-2]$r=-\infty$};
  \node[above=1,right=1,mydarkblue,align=centre] at (2,0) 
  ...
  \node[right=1,above=1,mydarkpurple,align=left] at (N) 
    {future timelike\\[-2]infinity ($i^+$)\\[-2]$t=+\infty$};
  \node[mydarkblue,below left=-1,align=centre] at (-1.5,-0.5) 
    {negative past\\[-2]lightlike infinity ($\calI^-$)};
  \node[mydarkblue,above left=-1,align=centre] at (-1.5,0.5) 
    {negative future\\[-2]lightlike infinity ($\calI^+$)};
  \node[mydarkblue,above right=-1,align=centre] at (1.5,0.5) 
    {positive future\\[-2]lightlike infinity ($\calI^+$)};
  \node[mydarkblue,below right=-1,align=centre] at (1.5,-0.5) 
