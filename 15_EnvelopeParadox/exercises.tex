...
\]
Use Bayes's theorem. The host’s choice depends on your initial pick and the hidden car's placement.
...
Sleeping Beauty is put to sleep. A fair coin is tossed. If heads, she is woken on Monday only. If tails, she is woken on Monday and Tuesday (but forgets Monday). Upon waking, what is her credence that the coin landed on heads?

\textit{Hint:} Model the wake-up events: \( \{\text{H-M}, \text{T-M}, \text{T-T}\} \). Normalise using the condition: \QSOpen{}I am awake now.\QSClose{}
