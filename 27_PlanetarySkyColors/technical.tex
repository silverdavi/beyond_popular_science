\begin{technical}
{\Large\textbf{Quantitative Analysis of Astronomical Colour}}\\[0.3em]
...
\]
Stellar temperatures can be inferred by fitting observed continua or via colour indices (e.g., \( B-V \)), which measure differences in magnitude across filtered bands.
...
\]
where \( \chi_i \) is the ionisation energy and \( N_e \) is the electron density. Line shapes are broadened by natural width, thermal Doppler broadening:
\[
...
\techref
{\footnotesize
Rybicki, G. B., and Lightman, A. P. (1979). \textit{Radiative Processes in Astrophysics}. Wiley.\\
