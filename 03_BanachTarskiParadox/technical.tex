...
\begin{itemize}[leftmargin=*]
    ...
    The unit ball is viewed as concentric spherical shells. The paradoxical decomposition is applied to each shell simultaneously. The centre is treated separately.
\end{itemize}
...
\vspace{0.5em}
\small
{\small \textbf{Figure:} Cayley graph of \(F_2\), visualised as a tree with no cycles and uniform branching.}
\end{center}

\techref
{\footnotesize
Banach, S. and Tarski, A. (1924). \textit{Fund. Math.} \textbf{6}\\
