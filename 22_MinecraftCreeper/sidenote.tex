\begin{SideNotePage}[1.1]{
  \textbf{Top (3D Mesh with UV Grid):} A polygonal model is shown with a superimposed UV grid. The grid flattens a surface into 2D coordinates, assigning each vertex to a location in texture space. This mapping determines how an image will be wrapped onto the surface. \par
