...
Each model was specified via constructor calls such as:
\[
\begin{aligned}
...
\vspace{0.3em}
\techheader{AI Composition and Swell Behaviour}\\[0.5em]
...
Minecraft Wiki. (2025). Entity Models and AI Mechanics. \textcolor{black}{\url{https://minecraft.wiki}}
}
\end{technical}