...
Black holes lose mass through radiation. The area law becomes a literal entropy, $S = k_B c^3 A/(4G\hbar)$, and the first law of black hole mechanics becomes the first law of thermodynamics. Hawking published in \textit{Nature} as \DSQOpen{}Black hole explosions?\DSQClose{} (1974), with a full derivation in \textit{Communications in Mathematical Physics} (1975). The result also introduced the information paradox: thermal radiation carries no trace of what fell in, contradicting unitarity.
