\begin{SideNotePage}{
  ...
  Two observers at the same point on Earth—one stationary, one walking—will disagree on what is happening right now (as seen from right here) in distant galaxies. A moon event (such as an egg breaking) can be \QSOpen{}now\QSClose{} for the stationary, and \QSOpen{}not yet\QSClose{} for the runner.\par
