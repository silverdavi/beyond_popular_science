...
\emph{Conditioning on a common effect induces spurious negative correlation (Berkson, 1946).}  
...
\emph{Statistical results depend on the choice of spatial or administrative boundaries (Openshaw, 1984).}  
