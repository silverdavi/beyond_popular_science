\begin{technical}
{\Large\textbf{Two Mathematical Realisations of Simpson's Paradox}}\\[0.3em]
\vspace{1em}
...
In such cases, the subgroup correlation reflects the actual relationship between the variables. The marginal correlation is an artefact of mixed distributions and should not be used to infer these relationships.
...
Pavlides, M. G., and Perlman, M. D. (2009). \textit{J. Stat. Plan. Inference}, 139(1), 198–213.
}
\end{technical}