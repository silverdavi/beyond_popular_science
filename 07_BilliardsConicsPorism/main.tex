...
(Side note: A \emph{porism} is a byproduct of a theorem, usually a sort of serendipitous corollary. Which reminds me of the joke by mathematician Jerry Bona, in which he described the equivalence of the Axiom of Choice (Zermelo, 1904), Zorn's Lemma, and the Well-Ordering Theorem as follows: \textit{\QENOpen{}The Axiom of Choice is obviously true, the Well-Ordering Theorem is obviously false, and Zorn's Lemma—who can tell?\QENClose{}} These statements are mathematically equivalent, yet their perceived plausibility varies widely.)
