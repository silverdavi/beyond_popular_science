\begin{SideNotePage}{
  ...
  The transition to electronic timing brought quartz crystal oscillators, tuning forks, and circuit-based digital clocks. Atomic clocks, such as the cesium beam and rubidium standards, use microwave transitions in atoms to define the second with extreme precision. These devices revolutionised navigation, telecommunications, and metrology. \par
