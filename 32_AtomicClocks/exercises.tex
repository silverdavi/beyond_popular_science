...
A classic riddle: given two candles, which each burn for 1 h, how can you measure 45 m?
\vspace{1em}
...
\]
The growth behaviour connects to ordinal $\varepsilon_0$. (See \hyperref[ch:bignumbers]{Chapter~17})
}