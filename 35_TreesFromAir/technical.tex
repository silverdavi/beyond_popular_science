...
\vspace{0.5em}
\techheader{Oxygen Source Identification via Isotope Labelling}

\vspace{0.2em}
\noindent The $^{18}\mathrm{O}$ labelling experiments by Ruben and Kamen (1941) definitively established oxygen source separation:
...
\vspace{0.2em}
\noindent Wood represents highly concentrated solar energy storage. \textbf{Energy density:} 16–20 MJ/kg (dry wood); \textbf{Solar capture efficiency:} 1–3\% of incident radiation; \textbf{Mature tree storage:} 50–100 GJ total (accumulated over decades); \textbf{Photon requirement:} ${\sim}$8–10 photons per $\mathrm{CO}_2$ molecule fixed.
...
\end{align*}
Over 50 years, each tree accumulates $\sim$2.5 tonnes carbon, corresponding to $\sim$5 tonnes total dry biomass—consistent with mature forest measurements.
...
\noindent Hydrogen: $\sim$6\% (from water)
