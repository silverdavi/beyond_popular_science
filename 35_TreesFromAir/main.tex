...
Isotopes are versions of an element with the same number of protons but different numbers of neutrons (Soddy, 1913). For example, oxygen has 8 protons and can have 8, 9, or 10 neutrons. This gives rise to the isotopes $^{16}\mathrm{O}$, $^{17}\mathrm{O}$, and $^{18}\mathrm{O}$. Carbon has 6 protons and can have 6, 7, or 8 neutrons. This gives rise to the isotopes $^{12}\mathrm{C}$, $^{13}\mathrm{C}$, and $^{14}\mathrm{C}$. Isotopes are a way to label atoms and track them in chemical reactions. This is how we know that the oxygen in wood comes from atmospheric $\mathrm{CO}_2$, not from the soil.

When water molecules are split in photosystem II (oxygenic photosynthesis), their oxygen atoms are released directly to the atmosphere as \(\mathrm{O}_2\) gas. Isotope labelling experiments using $^{18}\mathrm{O}$-enriched water demonstrated that the heavy oxygen appeared in the released gas, not in the organic products (Ruben et al., 1941). The oxygen atoms incorporated into cellulose and other biomolecules originate from \(\mathrm{CO}_2\). Every molecule of atmospheric oxygen released by plants represents a water molecule that was split to extract electrons, while the oxygen in wood records the atmospheric carbon that was fixed.
