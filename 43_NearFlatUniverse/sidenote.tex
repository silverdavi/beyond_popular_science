\begin{SideNotePage}{
  ...
  In the standard cosmological model, ΛCDM, space is spatially flat and infinite. Galaxies drift apart as distances expand—there is no centre, no edge, and every point sees the same large-scale dynamics.  \par
