...
TREE$(n)$ = max sequence of rooted finite trees with vertices coloured from an $n$-element set; on step $i$ the tree has at most $i$ vertices; forbid homeomorphic embedding from any earlier tree into any later.\\
TREE$(1) = 1$, TREE$(2) = 3$\\
...
\techref
{\footnotesize
M. H. Löb and S. S. Wainer, \QSOpen{}Hierarchies of number-theoretic functions I/II,\QSClose{} Archiv für mathematische Logik und Grundlagenforschung (1970–72).\\
H. Friedman, \QSOpen{}Finite forms of Kruskal's theorem,\QSClose{} Journal of Combinatorial Theory, Series A \textbf{95}, 102–144 (2001).
}
\end{technical}