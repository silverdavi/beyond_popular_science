\begin{SideNotePage}{
  ...
  Using 20 cm of ink, write the largest number possible. Early entries include exponential towers and Knuth up-arrow notation. But one leverages the TREE function hierarchy in $\text{TREE}(\text{TREE}(3))$—a number vastly larger than previous contenders. The final banner is a different type of entry, more reminiscent of Rayo's number. \par
