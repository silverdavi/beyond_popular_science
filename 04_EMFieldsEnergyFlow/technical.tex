...
\]
where $\star F$ is the Hodge dual of $F$, and $J$ is the 3-form representing charge and current density, Gauss's law. These equations encapsulate:
...
\end{itemize}
This formulation emphasises that electromagnetic phenomena, including the Poynting vector, arise naturally from spacetime geometry rather than as separate electric and magnetic field concepts in three-dimensional space. 

While defining these objects and proving their properties can take months, the payoff is nice: results like Maxwell’s equations emerge from simple geometric principles. Other results, such as the generalised Stokes’s theorem, follow with similar elegance.

\techref
{\footnotesize
Feynman, R. P., Leighton, R. B., and Sands, M. (1964). \textit{The Feynman Lectures on Physics}.\\
Baez, J. C., and Muniain, J. P. (1994). \textit{Gauge Fields, Knots and Gravity}.\\
}
\end{technical}